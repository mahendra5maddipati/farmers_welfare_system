...
<div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          <!--Upload form-->
          <form class="needs-validation" id="equipmentForm" enctype="multipart/form-data" method="post"
                autocomplete="off">
                <div class="row">
                  <div class="col-md-6">
                  <ol class="backgroundbreadcrumb breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-success" href="#">Equipments</a>
                        </li>
                    ...
                    <div class="form-group">
                        <label for="headerTitle">Equipment Name</label>
                        <input type="text" class="form-control" name="name_en"
                               placeholder="Enter name" required>
                        <small class="form-text text-muted">Name of the equipment</small>
                    </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label for="headerTitle">Equipment Price / పరికరం  ధర</label>
                              <input type="number" class="form-control" name="price"
                                     placeholder="Equipment / పరికరం " required>
                          </div>
                  </div>
                  <div class="col-md-6">
                  <ol class="backgroundbreadcrumb breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-success" href="#">పరికరాలు</a>
                        </li>
                        <li class="breadcrumb-item active">
                            Telugu Content
                        </li>
                    ...
                    <div class="form-group">
                        <label for="headerTitle">పరికరం  పేరు</label>
                        <input type="text" class="form-control" name="name_te"
                               placeholder="పేరు" required>
                        <small class="form-text text-muted">పరికరం  యొక్క పేరు</small>
                    </div>
                          <div class="form-group">
                ...
                <button class="btn btn-primary upload-image" onclick="addEquipment()" name="submitButton" id="submitButton" type="submit">
                    Submit
                </button>
            </form>
          <!-- /end of upload form -->
