...
<div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          <!--Upload form-->
          <form class="needs-validation" id="weatherForm" enctype="multipart/form-data" method="post"
                autocomplete="off">
                <div class="row">
                  <div class="col-md-6">
                  <ol class="backgroundbreadcrumb breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-success" href="#">Crop weather</a>
                        </li>
                        <li class="breadcrumb-item active">
                          ...
                          <div class="form-group">
                              <label for="headerTitle">Rainfall / వర్షపాతం</label>
                              <input type="text" class="form-control" name="rainfall"
                                     placeholder="Percentage / శాతం" required>
                          </div>
                          <div class="form-group">
                              <label for="headerTitle">Temparature / ఉష్ణోగ్రత</label>
                              <input type="text" class="form-control" name="temparature"
                                     placeholder="Degrees / డిగ్రీల" required>
                          </div>
                          <div class="form-group">
                              <label for="headerTitle">Humidity / తేమ</label>
                              <input type="text" class="form-control" name="humidity"
                                     placeholder="Percentage / శాతం" required>
                          </div>
                          <div class="form-group">
                              <label for="headerTitle">Wind / గాలి</label>
                  ...
                  <ol class="backgroundbreadcrumb breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-success" href="#">పంట వాతావరణం</a>
                        </li>
                        <li class="breadcrumb-item active">
                            Telugu Content
                        </li>
                ...
                <button class="btn btn-primary upload-image" onclick="addWeather()" name="submitButton" id="submitButton" type="submit">
                    Submit
                </button>
            </form>
          <!-- /end of upload form -->
