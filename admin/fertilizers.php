...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            <!--Upload form-->
            <form class="needs-validation" id="fertilizerForm" enctype="multipart/form-data" method="post"
                  autocomplete="off">
                  <div class="row">
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">Fertilizers</a>
                          </li>
                          <li class="breadcrumb-item active">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Fertilizer name</label>
                                <input type="text" class="form-control" name="fertilizername_en"
                                       placeholder="Fertilizer name" required>
                                <small class="form-text text-muted">Name of the fertilizer</small>
                            </div>
                            <div class="form-group">
                                <label for="headerTitle">Fertilizer Type</label>
                                <input type="text" class="form-control" name="fertilizertype_en"
                                       placeholder="Fertilizer Type" required>
                                <small class="form-text text-muted">Type of the fertilizer</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Fertilizer Price / ఎరువులు ధర</label>
                                <input type="number" accept="image/*" class="form-control" name="fertilizerprice"
                                       placeholder="Fertilizer / ఎరువులు" required>
                            </div>
                    </div>
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">ఎరువులు</a>
                          </li>
                          <li class="breadcrumb-item active">
                              Telugu Content
                          </li>
                            ...
                            <div class="form-group">
                                <label for="headerTitle">ఎరువులు పేరు</label>
                                <input type="text" class="form-control" name="fertilizername_te"
                                       placeholder="ఎరువులు పేరు" required>
                                <small class="form-text text-muted">ఎరువులు యొక్క పేర</small>
                            </div>
                            <div class="form-group">
                                <label for="headerTitle">ఎరువులు రకం</label>
                                <input type="text" class="form-control" name="fertilizertype_te"
                                       placeholder="ఎరువులు రకం" required>
                                <small class="form-text text-muted">ఎరువులు రకం</small>
                            </div>
                            <div class="form-group">
                  ...
                  <button class="btn btn-primary upload-image" onclick="addFertilizers()" name="submitButton" id="submitButton" type="submit">
                      Submit
                  </button>
              </form>
            <!-- /end of upload form -->
