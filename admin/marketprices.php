    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <form class="needs-validation" id="cropForm" enctype="multipart/form-data" method="post"
                  ...
                  <div class="row">
                    ...
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">Market Prices</a>
                          </li>
                          <li class="breadcrumb-item active">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Crop Price / పంట ధర</label>
                                <input type="number" class="form-control" name="cropprice"
                                       placeholder="Price / ధర" required>
                            </div>
                    </div>
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">మార్కెట్ ధరలు</a>
                          </li>
                          <li class="breadcrumb-item active">
                              Telugu Content
                          </li>
                  ...
                  <button class="btn btn-primary upload-image" onclick="addMarketPrice()" name="submitButton" id="submitButton" type="submit">
                      Submit
                  </button>
              </form>
            <!-- /end of upload form -->
