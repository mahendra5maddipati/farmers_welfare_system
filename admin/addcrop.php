...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!--Upload form-->
              <form class="needs-validation" id="cropForm" enctype="multipart/form-data" method="post"
                    autocomplete="off">
                    <div class="row">
                      <div class="col-md-6">
                      <ol class="backgroundbreadcrumb breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-success" href="#">Add Crops</a>
                            </li>
                            <li class="breadcrumb-item active">
                              ...
                              <div class="form-group">
                                  ...
                                  <small class="form-text text-muted">Comments on crop
                                  </small>
                              </div>
                      </div>
                      <div class="col-md-6">
                      <ol class="backgroundbreadcrumb breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-success" href="#">పంటలను చేర్చండి</a>
                            </li>
                            <li class="breadcrumb-item active">
                                Telugu Content
                            </li>
                              ...
                              <div class="form-group">
                                  ...
                                  <small class="form-text text-muted">పంటపై వ్యాఖ్యానించండి
                                  </small>
                              </div>
                      </div>
                    </div>
                    <button class="btn btn-primary upload-image" onclick="addCrop()" name="submitButton" id="submitButton" type="submit">
                        Submit
                    </button>
                </form>
            <!-- /end of upload form -->
