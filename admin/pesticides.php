...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            <!--Upload form-->
            <form class="needs-validation" id="pesticideForm" enctype="multipart/form-data" method="post"
                  autocomplete="off">
                  <div class="row">
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">Pesticides</a>
                          </li>
                          <li class="breadcrumb-item active">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Pesticide name</label>
                                <input type="text" class="form-control" name="pesticidename_en"
                                       placeholder="Pesticide name" required>
                                <small class="form-text text-muted">Name of the pesticide</small>
                            </div>
                            <div class="form-group">
                                <label for="headerTitle">Pesticide Type</label>
                                <input type="text" class="form-control" name="pesticidetype_en"
                                       placeholder="Pesticide Type" required>
                                <small class="form-text text-muted">Type of the pesticide</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Pesticide Price / పురుగుమందు ధర</label>
                                <input type="number" accept="image/*" class="form-control" name="pesticideprice"
                                       placeholder="Pesticide / పురుగుమందు" required>
                            </div>
                    </div>
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">పురుగుమందులు</a>
                          </li>
                          <li class="breadcrumb-item active">
                              Telugu Content
                          </li>
                            ...
                            <div class="form-group">
                                <label for="headerTitle">పురుగుమందు పేరు</label>
                                <input type="text" class="form-control" name="pesticidename_te"
                                       placeholder="పురుగుమందు పేరు" required>
                                <small class="form-text text-muted">పురుగుమందు యొక్క పేర</small>
                            </div>
                            <div class="form-group">
                                <label for="headerTitle">పురుగుమందు రకం</label>
                                <input type="text" class="form-control" name="pesticidetype_te"
                                       placeholder="పురుగుమందు రకం" required>
                                <small class="form-text text-muted">పురుగుమందుల రకం</small>
                            </div>
                            <div class="form-group">
                  ...
                  <button class="btn btn-primary upload-image" onclick="addPesticides()" name="submitButton" id="submitButton" type="submit">
                      Submit
                  </button>
              </form>
            <!-- /end of upload form -->
