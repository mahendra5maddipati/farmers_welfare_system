...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            <!--Upload form-->
            <form class="needs-validation" id="soilfertilityForm" enctype="multipart/form-data" method="post"
                  autocomplete="off">
                  <div class="row">
                    <div class="col-md-6">
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">Soil Fertility</a>
                          </li>
                      ...
                      <div class="form-group">
                          ...
                          <small class="form-text text-muted">Name of the District</small>
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Soil Type</label>
                                <input type="text" class="form-control" name="soiltype_en"
                                       placeholder="Fertilizer Type" required>
                                <small class="form-text text-muted">Type of the soil</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="headerTitle">Fertile Percentage / సారవంతం శాతం</label>
                                <input type="number" class="form-control" name="fertilepercentage"
                                       placeholder="Fertilizer Type" required>
                                <small class="form-text text-muted">Type of the soil</small>
                            </div>
                    </div>
                    ...
                    <ol class="backgroundbreadcrumb breadcrumb">
                          <li class="breadcrumb-item">
                              <a class="text-success" href="#">నేల సారవంతం</a>
                          </li>
                          <li class="breadcrumb-item active">
                              Telugu Content
                          </li>
                      ...
                      <div class="form-group">
                          ...
                          <small class="form-text text-muted">Name of the District</small>
                            ...
                            <div class="form-group">
                                <label for="headerTitle">నేల రకం</label>
                                <input type="text" class="form-control" name="soiltype_te"
                                       placeholder="ఎరువులు రకం" required>
                                <small class="form-text text-muted">నేల రకం</small>
                            </div>
                            <div class="form-group">
                  ...
                  <button class="btn btn-primary upload-image" onclick="addSoilFertility()" name="submitButton" id="submitButton" type="submit">
                      Submit
                  </button>
              </form>
            <!-- /end of upload form -->
