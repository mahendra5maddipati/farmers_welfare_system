...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _FERTILIZERS ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
<div class="services">
  <div class="container">
    <p class="w3ls_para"><?= _FERTILIZERS ?></p>
      <div class="card">
        <?php
          $pesticides = "";
          if(isset($_SESSION['lang'])){
              if ($_SESSION['lang'] == "en") {
                  $pesticides = "SELECT * FROM fertilizer_en";
              } else {
                  $pesticides = "SELECT * FROM fertilizer_te";
              }
          } else{
              $pesticides = "SELECT * FROM fertilizer_en";
          }
              ...
              foreach ($result as $crop) {
                  ...
                  echo "<div class='col-md-3 w3_agileits_stats_grid'>";
                    ...
                    echo "<img class='img-responsive' src=../posts/". $crop['file'] ." /><br/><br/>";
                      echo "<h3 style='color:green'>". $crop['fertilizername'] ."</h3><br/>";
                      echo "<h5 style='color:black'>". $crop['fertilizertype'] ."</h5><br/>";
                      echo "<h6 style='color:green'>" . _PRICE . "</h6>";
                      echo "<h3 style='color:black'>". $crop['fertilizerprice'] ."</h3><br/>";
