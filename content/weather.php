...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _WEATHER ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _WEATHER ?></p>
        ...
        <div id="verticalTab">
          ...
          if ($distresult && $distresult->num_rows > 0) {
              foreach ($distresult as $district) {
                  ...
                  if(isset($_SESSION['lang'])){
                      if ($_SESSION['lang'] == "en") {
                          $markets = "SELECT * FROM cropweather_en WHERE district = '$districtname'";
                      } else {
                          $markets = "SELECT * FROM cropweather_te WHERE district = '$districtname'";
                      }
                  } else{
                      $markets = "SELECT * FROM cropweather_en WHERE district = '$districtname'";
                  }
                    ...
                    echo '<div class="resp-tabs-container">';
                      echo '<div class="w3layouts_vertical_tab">';
                        ...
                        foreach ($marketresult as $market) {
                          echo '<div class="well">';
                            echo "<p style='color:orange;'>". _RAINFALL . " " . _PERCENTAGE . "</p>";
                            echo "<h3>" . $market['rainfall'] . "%</h3>";
                            echo "<hr/>";
                            echo "<p style='color:orange;'>". _TEMPARATURE . " " . _DEGREE . "</p>";
                            echo "<h3>" . $market['temperature'] . "</h3>";
                            echo "<hr/>";
                            echo "<p style='color:orange;'>". _HUMIDITY . " " . _PERCENTAGE . "</p>";
                            echo "<h3>" . $market['humidity'] . "%</h3>";
                            echo "<hr/>";
                            echo "<p style='color:orange;'>". _WIND . " " . _PERCENTAGE . "</p>";
                            echo "<h3>" . $market['wind'] . "%</h3>";
                            echo "<hr/>";
