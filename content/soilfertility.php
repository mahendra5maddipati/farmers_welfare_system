...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _SOIL_FERTILITY ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _SOIL_FERTILITY ?></p>
        ...
        <div id="verticalTab">
          ...
          if ($distresult && $distresult->num_rows > 0) {
              foreach ($distresult as $district) {
                  ...
                  if(isset($_SESSION['lang'])){
                      if ($_SESSION['lang'] == "en") {
                          $markets = "SELECT * FROM soilfertility_en WHERE district = '$districtname'";
                      } else {
                          $markets = "SELECT * FROM soilfertility_te WHERE district = '$districtname'";
                      }
                  } else{
                      $markets = "SELECT * FROM soilfertility_en WHERE district = '$districtname'";
                  }
                    ...
                    echo '<div class="resp-tabs-container">';
                      echo '<div class="w3layouts_vertical_tab">';
                        ...
                        foreach ($marketresult as $market) {
                          echo '<div class="well">';
                            echo "<p style='color:orange;'>". _SOIL_TYPE  . "</p>";
                            echo "<h3>" . $market['soiltype'] . "</h3>";
                            echo "<p style='color:orange;'>". _PERCENTAGE  . "<h4 style='color:black;'>" . '  '. $market['fertilepercentage'] . " %</p></h4>";
