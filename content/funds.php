...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _FUNDS ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _FUNDS ?></p>
      <br/>
      <div class="agileits_w3layouts_mail">
        <?php
          ...
          if(isset($_SESSION['lang'])){
              if ($_SESSION['lang'] == "en") {
                  $crops = "SELECT * FROM fund_en";
              } else {
                  $crops = "SELECT * FROM fund_te";
              }
          } else{
              $crops = "SELECT * FROM fund_en";
          }
              ...
              foreach ($result as $crop) {
                  ...
                  echo '<div class="col-md-4 agileits_w3layouts_mail_left">';
                    echo '<div class="w3_agileits_mail_left">';
                      echo '<h4><i class="fa fa-suitcase" aria-hidden="true"></i>'. $crop['fundname'] . '</h4>';
