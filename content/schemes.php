...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _SCHEMES ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _SCHEMES ?></p>
      <br/>
      <div class="agileits_w3layouts_mail">
        <?php
          ...
          if(isset($_SESSION['lang'])){
              if ($_SESSION['lang'] == "en") {
                  $crops = "SELECT * FROM scheme_en";
              } else {
                  $crops = "SELECT * FROM scheme_te";
              }
          } else{
              $crops = "SELECT * FROM scheme_en";
          }
              ...
              foreach ($result as $crop) {
                  ...
                  echo '<div class="col-md-4 agileits_w3layouts_mail_left">';
                    echo '<div class="w3_agileits_mail_left">';
                      echo '<h4><i class="fa fa-suitcase" aria-hidden="true"></i>'. $crop['scehemename'] . '</h4>';
                      echo '<p class="wthree_address">'. $crop['comments'] .'</p><br/>';
                    echo "</div>";
                  echo "</div>";
                  if ($i%3 == 0) {
