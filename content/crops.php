...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _CROPS ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _CROPS ?></p>
        <div class="card">
          <?php
            $crops = "";
            if(isset($_SESSION['lang'])){
                if ($_SESSION['lang'] == "en") {
                    $crops = "SELECT * FROM crop_en";
                } else {
                    $crops = "SELECT * FROM crop_te";
                }
            } else{
                $crops = "SELECT * FROM crop_en";
            }
                ...
                foreach ($result as $crop) {
                    ...
                    echo "<div class='col-md-3 w3_agileits_stats_grid'>";
                      echo "<div style='background-color:#5a575757' class='agileits_w3layouts_stats_grid'>";
                        echo "<i class='fa fa-leaf' aria-hidden='true'></i><br/><br/>";
                        echo "<h2 style='color:#72994a'>". $crop['name'] ."</h2><br/>";
                        echo "<h4 style='line-height: 1.6;'>". strip_tags($crop['comments']) . "</h4>";
                      echo "</div>";
                    echo "</div>";
                    if ($i%4 == 0) {
