...
<!-- banner -->
    ...
    <br/>
    <h1 style="color:white;font-size: 50px; text-shadow: 3px 4px 2px black;" class="mx-auto d-block text-center"><?= _MARKET_PRICES ?></h1>
	</div>
<!-- //banner -->
<!-- services -->
	<div class="services">
		<div class="container">
			<p class="w3ls_para"><?= _MARKET_PRICES ?></p>
        ...
        <div id="verticalTab">
          ...
          if ($distresult && $distresult->num_rows > 0) {
              foreach ($distresult as $district) {
                  ...
                  if(isset($_SESSION['lang'])){
                      if ($_SESSION['lang'] == "en") {
                          $markets = "SELECT * FROM marketprice_en WHERE district = '$districtname'";
                      } else {
                          $markets = "SELECT * FROM marketprice_te WHERE district = '$districtname'";
                      }
                  } else{
                      $markets = "SELECT * FROM marketprice_en WHERE district = '$districtname'";
                  }
                    ...
                    echo '<div class="resp-tabs-container">';
                      echo '<div class="w3layouts_vertical_tab">';
                        ...
                        foreach ($marketresult as $market) {
                          echo '<div class="well">';
                            echo "<p style='color:orange;'>". _CROPS  . "</p>";
                            echo "<h3>" . $market['cropname'] . "</h3>";
                            echo "<p style='color:orange;'>"._PRICE  . "<h4 style='color:black;'>" . '  '. $market['cropprice'] . "</p></h4>";
